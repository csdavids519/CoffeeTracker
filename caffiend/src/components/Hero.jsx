    ...
    return (
        <>
            ...
            <div className="card info-card">
                ...
                <p>This means that after 5 hours, half the caffeine you consumed is still in tyour system, keeping you alert longer!
                    So if you dring a cup of cofee with 200 mg of caffeine, 5 hours, later, your&apos;ll still have about 100 mg of caffeine in your system.
                </p>
            </div>
